								...
								>
									...
									<div className="w-100">
										<div className="d-flex justify-content-between w-100 px-3 pt-2">
											...
											<div className="d-flex align-items-center themeColor font-weight-bold">
												<h6 className="mr-1 mb-0">Aujourd’hui - 12:00</h6>
												<RiArrowRightSLine fontSize="2rem" color="#4b4b4b" />
											</div>
										</div>
			...
			<div className="w-100 border-left">
				...
				<div className="messagesBody">
					<div className="singleMessageD d-flex pl-2">
						<img
							width="10%"
							className="messageUser mt-3 rounded-circle"
							src={client}
							alt="client"
						/>
						<div
					...
					<div className="singleMessageD d-flex pl-2">
						...
						>
							<div className="text-center mb-2">
								<img src={annonces1} alt="annonces1" className="sentImg" />
							</div>
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem
						</div>
					</div>
