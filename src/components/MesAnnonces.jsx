...
const MesAnnonces = () => {
	return (
		<div className="container-fluid mesContainer px-0">
			<div>
				<h1 className="font-weight-bold">Mes Annonces</h1>
			</div>
			<div className="row px-0">
				<div className="col-12 d-flex justify-content-between">
					<button className="themeBtn px-3 mr-4">
						<FiFilter fontSize="2.2rem" />
					</button>
					<div className="inpContainer">
						<input type="text" placeholder="Chaussure Nike" />
						<BsSearch className="searchIcon" color="#525252" />
					</div>
					<button className="themeBtn2 px-3 ml-4">
						Classer par <BiSortDown fontSize="2.2rem" />
					</button>
				</div>

				<div className="col-12 justify-content-between align-items-center mt-3">
					<div className="d-flex align-items-baseline">
						<h3 className="font-weight-bold">Chaussure Nike</h3>
						<h4 className="ml-4 font-weight-bold themeColor2">
				...
				{[1, 1, 1, 1, 1].map((prev, i) => {
					return (
						<div key={i} className="cardContainer mt-4 col-12">
							<div className="d-flex borderRounded shadow bg-white">
								<img className="section1" src={annonces1} alt="annonces" />
								<div className="section2 d-flex flex-column">
									<div className="d-flex justify-content-between">
										<div className="mt-3 ml-3">
											<h2 className="themeColor font-weight-bold">
												Chaussure Nike a vendre
											</h2>
											<h3 className="font-weight-bold">800 000 FG</h3>
											{(i === 2 && (
												<div className="booste">Boosté pour 1 jour</div>
											)) ||
												(i === 4 && (
													<div className="booste">Boosté pour 1 jour</div>
												))}
									...
									<div className="bottomSection d-flex justify-content-around align-items-center">
