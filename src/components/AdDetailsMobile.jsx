				...
				<div className="bg-white p-4">
					...
					<div className="userBtn w-100 d-flex bg-white mt-4">
						<button
							...
							className="text-white py-3 px-0 d-flex justify-content-center align-items-center w-100 mr-4"
						>
						...
						<button
							...
							className="text-white py-3 px-0 d-flex justify-content-center align-items-center w-100"
						>
					...
					<div>
						...
						<h3 className="m-0 text-justify descriptionText">
							La première Air Max lifestyle de Nike vous offre style et confort
							à travers la Nike Air Max 270. Ce modèle s'inspire des chaussures
							Air Max emblématiques en intégrant les meilleures innovations de
							Nike, avec sa grande fenêtre et une nouvelle gamme de couleurs.
						</h3>
					</div>
					{/* DESCRIPTION END */}

					{/* INFROMATION SECTION START */}
					<div className="mt-5">
